...
@section('title', 'Create Pendanaan')
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Pendanaan</h3>
                </div>
                <!-- /.card-header -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggalCekSaldo" class="form-control @error('tanggalCekSaldo') is-invalid @enderror" placeholder="">
                            ...
                            <div class="col-6">
                                <div class="form-gorup">
                                    ...
                                    <input type="time" name="jamCekSaldo" class="form-control @error('jamCekSaldo') is-invalid @enderror" placeholder="">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="jumlahSaldo" class="form-control @error('jumlahSaldo') is-invalid @enderror" placeholder="">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggalTopup" class="form-control @error('tanggalTopup') is-invalid @enderror" placeholder="">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" name="jamTopup" class="form-control @error('jamTopup') is-invalid @enderror" placeholder="">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="jumlahTopup" class="form-control @error('jumlahTopup') is-invalid @enderror" placeholder="">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="jumlahSetelahTopup" class="form-control @error('jumlahSetelahTopup') is-invalid @enderror" placeholder="">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="statusIklan" list="statusIklan" class="form-control custom-select @error('statusIklan') is-invalid @enderror" placeholder="Status Iklan">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" placeholder="">
