                        ...
                        <tbody>
                            @foreach ($iklan as $pengiklan)
                                <tr>
                                    ...
                                    <td>{{ $pengiklan->daftarAds }}</td>
                                    <td>{{ $pengiklan->reach }}</td>
                                    <td>{{ $pengiklan->amountSpent }}</td>
                                    <td>{{ $pengiklan->cpm }}</td>
                                    <td>{{ $pengiklan->costPerOutBoundClick }}</td>
                                    <td>{{ $pengiklan->outboundClick }}</td>
                                    <td>{{ $pengiklan->messagingConversation }}</td>
                                    <td>
